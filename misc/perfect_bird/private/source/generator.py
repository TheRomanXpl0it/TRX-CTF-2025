...
while i < iterations:
	...
	if i != 0:
		print('   ' + f'if ({";;" * random.randint(1, 20)}42) ' + '{')
	print('   ' * random.choice([0, 2]) + f'const var v = m[a-1]' + '!' * random.randint(1, 10))
	print('   ' * random.choice([0, 2]) + f'const var w = ((42 ^ v) % 256) ^ {hex(QWORD[i % QWORD_SIZE])}' + '!' * random.randint(1, 10))
	print('   ' * random.choice([0, 2]) + f'm[a-1] = w' + '!' * random.randint(1, 10))
	print('   ' * random.choice([0, 2]) + f'const var a<-3> = 42 % {len(flag)}' + '!' * random.randint(1, 10))
	print('   ' * random.choice([0, 2]) + '42 += 1' + '!' * random.randint(1, 10))
	if i != 0:
		print('   ' + '}')
	i += 1

mem = [205, 242, 231, 208, 235, 150, 5, 14, 162, 115, 134, 81, 118, 138, 49, 16, 54, 142, 80, 102, 139, 35, 127, 83, 52, 106, 200, 185, 153, 203, 34, 66, 62, 12, 7, 166, 34, 81, 250]
print(f'     const const const m<-34434> = {mem}!')
print('   print(m)!')
print('}')
